        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <div className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              {/* Email/Password Form - Now Separated */}
              ...
              {/* Social Login Section - Now Outside Form */}
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <title>Login with Microsoft</title>
                      <path fill="currentColor" d="m0 0v10.719h10.719v-10.719zm13.279 0v10.719h10.719v-10.719zm-13.279 13.281v10.719h10.719v-10.719zm13.279 0v10.719h10.719v-10.719z"/>
                  </svg>
